...
> Note:
> The first version of this project was entirely generated by [AdaL](https://sylph.ai) .
> Afterwards I have used [Claude Code](https://code.claude.com) as well.
> I have also used this product to extend itself

A command-line interactive coding agent built in Rust with support for OpenAI and Anthropic LLM APIs.
Works on Mac, Windows, Linux including Raspberry Pi.
...
- [Windows](https://github.com/debamitro/one-shot-cli-agent/releases/download/v0.7/codeagent_0.7_win.zip)
- [MacOS (Apple Silicon)](https://github.com/debamitro/one-shot-cli-agent/releases/download/v0.7/codeagent_0.7_aarch64-apple-darwin.zip)
- [MacOS (Intel)](https://github.com/debamitro/one-shot-cli-agent/releases/download/v0.7/codeagent_0.7_x86_64-apple-darwin.zip)
- [Linux (x86_64)](https://github.com/debamitro/one-shot-cli-agent/releases/download/v0.7/codeagent_0.7_linux_x86_64.zip)
- [Linux (aarch64)](https://github.com/debamitro/one-shot-cli-agent/releases/download/v0.7/codeagent_0.7_linux_aarch64.zip)
...
```bash
# With Z.ai GLM
codeagent --provider anthropic --api-key ... --anthropic-base-url https://api.z.ai/api/anthropic --model GLM-4.7

# With Ollama (local LLM)
codeagent --provider openai --api-key ollama --openai-base-url http://localhost:11434 --model qwen3.5:9b
```
...
Options:
  ...
  -s, --session <SESSION>                Session ID to resume
      ...
      --persona <PERSONA>                Built-in persona (default, concise, teacher, reviewer, architect, shakespeare)
